...
<div class="row" style="margin-top:2%;">
    <div class="col-md-4">
        ...
        {{Form::select('project_type', ['Website' => 'Website', 'Software' => 'Software', 'Web service' => 'Web service', 'Cloud' => 'Cloud', 'Other' => 'Other'], null ,['class' => 'form-control','required' => 'true'])}}
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
        ...
        {{Form::select('project_status', ['On going' => 'On going', 'Complete' => 'Complete'], null ,['class' => 'form-control','required' => 'true'])}}
    </div>
</div>
